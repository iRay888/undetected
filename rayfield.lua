...
local Rayfield = useStudio and script.Parent:FindFirstChild('Rayfield') or game:GetObjects("rbxassetid://103938869575334")[1]
...
repeat
	...
	toDestroy, Rayfield = Rayfield, useStudio and script.Parent:FindFirstChild('Rayfield') or game:GetObjects("rbxassetid://103938869575334")[1]
...
-- load new undetected assets here

local assetFiles = {
    ["111263549366178"] = "https://github.com/iRay888/undetected/blob/main/images/111263549366178.png?raw=true",
    ["77891951053543"] = "https://github.com/iRay888/undetected/blob/main/images/77891951053543.png?raw=true",
    ["78137979054938"] = "https://github.com/iRay888/undetected/blob/main/images/78137979054938.png?raw=true",
    ["80503127983237"] = "https://github.com/iRay888/undetected/blob/main/images/80503127983237.png?raw=true",
    ["10137832201"] = "https://github.com/iRay888/undetected/blob/main/images/10137832201.png?raw=true",
    ["10137941941"] = "https://github.com/iRay888/undetected/blob/main/images/10137941941.png?raw=true",
    ["11036884234"] = "https://github.com/iRay888/undetected/blob/main/images/11036884234.png?raw=true",
    ["11413591840"] = "https://github.com/iRay888/undetected/blob/main/images/11413591840.png?raw=true",
    ["11745872910"] = "https://github.com/iRay888/undetected/blob/main/images/11745872910.png?raw=true",
    ["12577727209"] = "https://github.com/iRay888/undetected/blob/main/images/12577727209.png?raw=true",
    ["18458939117"] = "https://github.com/iRay888/undetected/blob/main/images/18458939117.png?raw=true",
    ["3259050989"] = "https://github.com/iRay888/undetected/blob/main/images/3259050989.png?raw=true",
    ["3523728077"] = "https://github.com/iRay888/undetected/blob/main/images/3523728077.png?raw=true",
    ["3602733521"] = "https://github.com/iRay888/undetected/blob/main/images/3602733521.png?raw=true",
    ["3926305904"] = "https://github.com/iRay888/undetected/blob/main/images/3926305904.png?raw=true",
    ["4483362458"] = "https://github.com/iRay888/undetected/blob/main/images/4483362458.png?raw=true",
    ["5587865193"] = "https://github.com/iRay888/undetected/blob/main/images/5587865193.png?raw=true",
    ["8445471332"] = "https://github.com/iRay888/undetected/blob/main/images/8445471332.png?raw=true",
}

local customAssets = {} -- table with new custom assets

for id, _ in assetFiles do
    customAssets[tostring(id)] = ""
end

if getcustomasset and writefile and makefolder and isfile and isfolder then
    if not isfolder("rayfield assets") then
        makefolder("rayfield assets")
    end

    local function isDone()
        for id, _ in assetFiles do
            if not isfile("rayfield assets/" .. tostring(id) .. ".png") then
                return id
            end
        end
        ...
        task.spawn(function()
            while true do
                ...
                if done == true then
                    ...
                    writefile("rayfield assets/" .. tostring(done) .. ".png", httpGet(assetFiles[done]))
                    task.wait()
                end
            end
        end)
    ...
    for id, _ in assetFiles do
        customAssets[tostring(id)] = getcustomasset("rayfield assets/" .. tostring(id) .. ".png")
    end
end
...
Rayfield.Main.Preview.Shadow.Image.Image = customAssets[tostring(5587865193)]
Rayfield.Main.Preview.PreviewImage.Image = customAssets[tostring(12577727209)]
